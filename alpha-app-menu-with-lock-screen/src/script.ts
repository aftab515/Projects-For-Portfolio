...
const Reminder: React.FC = () => {
  return(
    <div className="reminder">
      ...
      <span className="reminder-text">Uniting technology for a better tomorrow <span className="reminder-time">For Everyone</span></span>      
    </div>
  )
}
    ...
    <div id="app-menu">      
      <div id="app-menu-content-wrapper">
        <div id="app-menu-content">
          ...
          <QuickNav />
          <a id="github-link" className="clear-button" href="https://github.com/aftab515" target="_blank">
            <i className="fa-brands fa-github" />  
            <span> Aftab Sadiq </span>
          </a>
          <Weather />                  
          <Restaurants />
          <Tools />
